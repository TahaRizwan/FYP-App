...
public class MenSaloonAdapter extends RecyclerView.Adapter<MenSaloonAdapter.myviewholder> {
    ...
    public MenSaloonAdapter(Context context, ArrayList<CarWashModel> list) {
