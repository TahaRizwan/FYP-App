...
public class WomenSaloonAdapter extends RecyclerView.Adapter<WomenSaloonAdapter.myviewholder> {
    ...
    public WomenSaloonAdapter(Context context, ArrayList<CarWashModel> list) {
