...
public class CarpenterAdapter extends RecyclerView.Adapter<CarpenterAdapter.myviewholder> {
    ...
    public CarpenterAdapter(Context context, ArrayList<CarWashModel> list) {
