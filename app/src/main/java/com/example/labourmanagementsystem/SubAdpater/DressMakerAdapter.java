...
public class DressMakerAdapter extends RecyclerView.Adapter<DressMakerAdapter.myviewholder> {
    ...
    public DressMakerAdapter(Context context, ArrayList<CarWashModel> list) {
