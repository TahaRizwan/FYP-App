...
public class HomeTutorAdapter extends RecyclerView.Adapter<HomeTutorAdapter.myviewholder> {
    ...
    public HomeTutorAdapter(Context context, ArrayList<CarWashModel> list) {
