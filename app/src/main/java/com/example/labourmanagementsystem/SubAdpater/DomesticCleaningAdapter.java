...
public class DomesticCleaningAdapter extends RecyclerView.Adapter<DomesticCleaningAdapter.myviewholder> {
    ...
    public DomesticCleaningAdapter(Context context, ArrayList<CarWashModel> list) {
