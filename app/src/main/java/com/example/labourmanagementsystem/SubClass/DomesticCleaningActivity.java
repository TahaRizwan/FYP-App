...
public class DomesticCleaningActivity extends AppCompatActivity implements DomesticCleaningAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    DomesticCleaningAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_domestic_cleaning);
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.domesticrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Domestic Cleaning");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new DomesticCleaningAdapter(DomesticCleaningActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(DomesticCleaningActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(DomesticCleaningActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(DomesticCleaningActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(DomesticCleaningActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Domestic Cleaning");
