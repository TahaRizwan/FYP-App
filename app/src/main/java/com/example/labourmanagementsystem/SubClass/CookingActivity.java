...
public class CookingActivity extends AppCompatActivity implements CookingAdapter.GetItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.cookingrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Cooking Tutor");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new CookingAdapter(CookingActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(CookingActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(CookingActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(CookingActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(CookingActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Cooking Tutor");
