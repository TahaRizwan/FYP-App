...
public class PlumberActivity extends AppCompatActivity implements PlumberAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    PlumberAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.plumberrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Plumber");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new PlumberAdapter(PlumberActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(PlumberActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(PlumberActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(PlumberActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(PlumberActivity.this,RequestActivity.class);
