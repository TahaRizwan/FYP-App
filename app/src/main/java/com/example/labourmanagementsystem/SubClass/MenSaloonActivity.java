...
public class MenSaloonActivity extends AppCompatActivity implements MenSaloonAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    MenSaloonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_men_saloon);
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.mensaloonrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Mens Barber");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new MenSaloonAdapter(MenSaloonActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(MenSaloonActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(MenSaloonActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(MenSaloonActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(MenSaloonActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Mens Barber");
