...
import com.example.labourmanagementsystem.SubRequests.WomenRequestActivity;
...
public class PainterActivity extends AppCompatActivity implements PainterAdapter.GetItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.painterrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Painter");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new PainterAdapter(PainterActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(PainterActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(PainterActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(PainterActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(PainterActivity.this, RequestActivity.class);
