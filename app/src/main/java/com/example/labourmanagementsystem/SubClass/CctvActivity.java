...
public class CctvActivity extends AppCompatActivity implements CctvAdapter.GetItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.cctvrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("CCTV");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new CctvAdapter(CctvActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(CctvActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(CctvActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(CctvActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(CctvActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","CCTV");
