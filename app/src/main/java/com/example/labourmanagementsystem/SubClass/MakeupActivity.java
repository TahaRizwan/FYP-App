...
public class MakeupActivity extends AppCompatActivity implements MakeupAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    MakeupAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.makeuprv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Makeup Artist");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new MakeupAdapter(MakeupActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(MakeupActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(MakeupActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(MakeupActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(MakeupActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Makeup Artist");
