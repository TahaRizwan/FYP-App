...
import com.example.labourmanagementsystem.SubAdpater.TailorAdapter;
...
public class TailorActivity extends AppCompatActivity implements TailorAdapter.GetItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.tailorrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Tailor");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new TailorAdapter(TailorActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(TailorActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(TailorActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(TailorActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(TailorActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Tailor");
