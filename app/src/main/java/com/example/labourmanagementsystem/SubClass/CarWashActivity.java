...
public class CarWashActivity extends AppCompatActivity implements CarWashAdapter.GetItem{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.carwashrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Car Wash");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new CarWashAdapter(CarWashActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(CarWashActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(CarWashActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(CarWashActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(CarWashActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Car Wash");
