...
public class HomeTutorActivity extends AppCompatActivity implements HomeTutorAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    HomeTutorAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.home_tutor_rv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Home Tutor");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new HomeTutorAdapter(HomeTutorActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(HomeTutorActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(HomeTutorActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(HomeTutorActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(HomeTutorActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Home Tutor");
