...
public class CarpenterActivity extends AppCompatActivity implements CarpenterAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    CarpenterAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.carpenterrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Carpenter");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new CarpenterAdapter(CarpenterActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(CarpenterActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(CarpenterActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(CarpenterActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(CarpenterActivity.this,RequestActivity.class);
