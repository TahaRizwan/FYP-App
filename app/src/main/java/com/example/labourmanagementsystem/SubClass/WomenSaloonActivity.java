...
public class WomenSaloonActivity extends AppCompatActivity implements WomenSaloonAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    WomenSaloonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_saloon);
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.womensaloonrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Women Barber");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new WomenSaloonAdapter(WomenSaloonActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(WomenSaloonActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(WomenSaloonActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(WomenSaloonActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(WomenSaloonActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Women Barber");
