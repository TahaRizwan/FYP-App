...
public class CivilActivity extends AppCompatActivity implements CivilAdapter.GetItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.civilrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Civil Engineer");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new CivilAdapter(CivilActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(CivilActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(CivilActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(CivilActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(CivilActivity.this,RequestActivity.class);
                intent.putExtra("Labour Id",labourId);
                intent.putExtra("Skill","Civil Engineer");
