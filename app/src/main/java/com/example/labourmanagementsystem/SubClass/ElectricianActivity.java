...
public class ElectricianActivity extends AppCompatActivity implements ElectricianAdapter.GetItem {

    RecyclerView rv;
    ProgressDialog progressDialog;
    TextView ndts;
    ElectricianAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        rv=(RecyclerView)findViewById(R.id.elecrv);
        database= FirebaseDatabase.getInstance().getReference("Labours").child("Electrician");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new ElectricianAdapter(ElectricianActivity.this,listcarwash);

                rv.setLayoutManager(new LinearLayoutManager(ElectricianActivity.this));
                rv.setAdapter(adapter);
                adapter.setClickListener(ElectricianActivity.this);
    ...
    public void itemPosition(CarWashModel pos) {
        Dialog dialog = new Dialog(ElectricianActivity.this);
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(ElectricianActivity.this,RequestActivity.class);
