...
import com.example.labourmanagementsystem.SubClass.CarpenterActivity;
import com.example.labourmanagementsystem.SubClass.InteriorActivity;

import java.util.ArrayList;

public class FittingAdapter extends RecyclerView.Adapter<FittingAdapter.viewHolder>{

    ArrayList<PojoModel> list;
    //Context context;

    public FittingAdapter(ArrayList<PojoModel> list) {
        this.list = list;
        ...
        switch (position){
            ...
            case 0:
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        v.getContext().startActivity(new Intent(v.getContext(), CarpenterActivity.class));
                    }
                });
                break;
            ...
            case 1:
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        v.getContext().startActivity(new Intent(v.getContext(), InteriorActivity.class));
                    }
                });
                break;
