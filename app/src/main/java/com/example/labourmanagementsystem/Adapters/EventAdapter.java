...
import com.example.labourmanagementsystem.SubClass.ServiceData;
...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.viewHolder>{
    ...
    public interface getItem{
        static void itemPosition(PojoModel pos) {

        }
    }

    public EventAdapter(ArrayList<PojoModel> list) {
        this.list = list;
            ...
            case 0:
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        v.getContext().startActivity(new Intent(v.getContext(),ServiceData.class));
                    }
                });
